...
export default function Profile() {
    ...
    const handleFollowToggle = async () => {
        ...
        console.log("Follow Toggle Profile:", {
        ...
        try {
            if (isFollowing) {
                // Unfollow
                console.log("Unfollowing from Profile...");
            ...
            addToast(t('something_went_wrong') + `: ${error.message}`, 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <>
            <div className="max-w-4xl mx-auto w-full pb-20 animate-fade-in p-4">
                ...
                </div>same robust name logic for the avatar initials */}
                                    <img
...

    {
        ...
        {/* User List Modal - Outside Main Flow */ }
        < UserListModal
