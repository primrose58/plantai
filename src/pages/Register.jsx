import { doc, setDoc, serverTimestamp } from 'firebase/firestore'; // Import needed functions
import { db, auth } from '../services/firebase'; // Ensure db is imported
...
const handleSubmit = async (e) => {
    ...
    try {
        ...
        await setDoc(doc(db, "users", result.user.uid), {
            uid: result.user.uid,
            name: name,
            displayName: name, // Keep both for compatibility
            email: email,
            photoURL: null,
            avatar: null,
